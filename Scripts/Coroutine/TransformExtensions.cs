...
namespace UniT.Easings
{
    ...
    public static partial class TransformExtensions
    {
        ...
        public static IEnumerator RotateAsync(this Transform target, Vector3 begin, Vector3 end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
            var wrapper = new Action<Vector3>(value => target.rotation = Quaternion.Euler(value));
            return Apply(wrapper, Wrap(begin, end), end, duration, function, ignoreTimeScale, callback);
        }

        public static IEnumerator RotateXAsync(this Transform target, float begin, float end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
            ...
            return ApplyX(getter, setter, Wrap(begin, end), end, duration, function, ignoreTimeScale, callback);
        }

        public static IEnumerator RotateYAsync(this Transform target, float begin, float end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
            var getter = new Func<Vector3>(() => target.rotation.eulerAngles);
            var setter = new Action<Vector3>(value => target.rotation = Quaternion.Euler(value));
            return ApplyY(getter, setter, Wrap(begin, end), end, duration, function, ignoreTimeScale, callback);
        }

        public static IEnumerator RotateZAsync(this Transform target, float begin, float end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
            var getter = new Func<Vector3>(() => target.rotation.eulerAngles);
            var setter = new Action<Vector3>(value => target.rotation = Quaternion.Euler(value));
            return ApplyZ(getter, setter, Wrap(begin, end), end, duration, function, ignoreTimeScale, callback);
        }

        public static IEnumerator RotateAsync(this Transform target, Vector3 end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
            return target.RotateAsync(target.rotation.eulerAngles, end, duration, function, ignoreTimeScale, callback);
        }

        public static IEnumerator RotateXAsync(this Transform target, float end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
            return target.RotateXAsync(target.rotation.eulerAngles.x, end, duration, function, ignoreTimeScale, callback);
        }

        public static IEnumerator RotateYAsync(this Transform target, float end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
            return target.RotateYAsync(target.rotation.eulerAngles.y, end, duration, function, ignoreTimeScale, callback);
        }

        public static IEnumerator RotateZAsync(this Transform target, float end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
            return target.RotateZAsync(target.rotation.eulerAngles.z, end, duration, function, ignoreTimeScale, callback);
        }

        public static IEnumerator RotateAsync(this Transform target, Quaternion begin, Quaternion end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
            return target.RotateAsync(begin.eulerAngles, end.eulerAngles, duration, function, ignoreTimeScale, callback);
        }

        public static IEnumerator RotateAsync(this Transform target, Quaternion end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
            return target.RotateAsync(target.rotation, end, duration, function, ignoreTimeScale, callback);
        }
        ...
        public static IEnumerator LocalRotateAsync(this Transform target, Vector3 begin, Vector3 end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
            var wrapper = new Action<Vector3>(value => target.localRotation = Quaternion.Euler(value));
            return Apply(wrapper, Wrap(begin, end), end, duration, function, ignoreTimeScale, callback);
        }

        public static IEnumerator LocalRotateXAsync(this Transform target, float begin, float end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
        ...
        public static IEnumerator LocalRotateYAsync(this Transform target, float begin, float end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
            var getter = new Func<Vector3>(() => target.localRotation.eulerAngles);
            var setter = new Action<Vector3>(value => target.localRotation = Quaternion.Euler(value));
            return ApplyY(getter, setter, Wrap(begin, end), end, duration, function, ignoreTimeScale, callback);
        ...
        public static IEnumerator LocalRotateZAsync(this Transform target, float begin, float end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
            var getter = new Func<Vector3>(() => target.localRotation.eulerAngles);
            var setter = new Action<Vector3>(value => target.localRotation = Quaternion.Euler(value));
            return ApplyZ(getter, setter, Wrap(begin, end), end, duration, function, ignoreTimeScale, callback);
        ...
        public static IEnumerator LocalRotateAsync(this Transform target, Vector3 end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
            return target.LocalRotateAsync(target.localRotation.eulerAngles, end, duration, function, ignoreTimeScale, callback);
        }

        public static IEnumerator LocalRotateXAsync(this Transform target, float end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
            return target.LocalRotateXAsync(target.localRotation.eulerAngles.x, end, duration, function, ignoreTimeScale, callback);
        }

        public static IEnumerator LocalRotateYAsync(this Transform target, float end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
            return target.LocalRotateYAsync(target.localRotation.eulerAngles.y, end, duration, function, ignoreTimeScale, callback);
        }

        public static IEnumerator LocalRotateZAsync(this Transform target, float end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
            return target.LocalRotateZAsync(target.localRotation.eulerAngles.z, end, duration, function, ignoreTimeScale, callback);
        }

        public static IEnumerator LocalRotateAsync(this Transform target, Quaternion begin, Quaternion end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
            return target.LocalRotateAsync(begin.eulerAngles, end.eulerAngles, duration, function, ignoreTimeScale, callback);
        }

        public static IEnumerator LocalRotateAsync(this Transform target, Quaternion end, float duration, Easing.Function function = default, bool ignoreTimeScale = false, Action callback = null)
        {
            return target.LocalRotateAsync(target.localRotation, end, duration, function, ignoreTimeScale, callback);
        }
