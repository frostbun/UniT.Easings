...
namespace UniT.Easings
{
    ...
    public static class GraphicExtensions
    {
        ...
        public static IEnumerator ChangeRAsync(this Graphic target, float begin, float end, float duration, Easing.Function? function = null, bool ignoreTimeScale = false, Action? callback = null)
        {
        ...
        public static IEnumerator ChangeGAsync(this Graphic target, float begin, float end, float duration, Easing.Function? function = null, bool ignoreTimeScale = false, Action? callback = null)
        {
            var getter = new Func<Color>(() => target.color);
            var setter = new Action<Color>(value => target.color = value);
        ...
        public static IEnumerator ChangeBAsync(this Graphic target, float begin, float end, float duration, Easing.Function? function = null, bool ignoreTimeScale = false, Action? callback = null)
        {
            var getter = new Func<Color>(() => target.color);
            var setter = new Action<Color>(value => target.color = value);
        ...
        public static IEnumerator ChangeRAsync(this Graphic target, float end, float duration, Easing.Function? function = null, bool ignoreTimeScale = false, Action? callback = null)
        {
            return target.ChangeRAsync(target.color.r, end, duration, function, ignoreTimeScale, callback);
        }

        public static IEnumerator ChangeGAsync(this Graphic target, float end, float duration, Easing.Function? function = null, bool ignoreTimeScale = false, Action? callback = null)
        {
            return target.ChangeGAsync(target.color.g, end, duration, function, ignoreTimeScale, callback);
        }

        public static IEnumerator ChangeBAsync(this Graphic target, float end, float duration, Easing.Function? function = null, bool ignoreTimeScale = false, Action? callback = null)
        {
